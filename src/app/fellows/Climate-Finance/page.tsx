...
import { climatefinanceFellows } from "../../../../data/fellows/climate-finance"
        ...
        >
            ...
            <div className="relative bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 border border-gray-100">
                ...
                <div className="relative aspect-[3/4] overflow-hidden bg-gradient-to-br from-blue-50 to-purple-50">
                    ...
                    {/* Country Badge - Top Right (only if we have one) */}
                    {fellow.country && (
                ...
                <div className="flex flex-col md:flex-row h-full max-h-[90vh]">
                    ...
                    <div className="flex-1 flex flex-col overflow-hidden">
                        ...
                        <div className="flex-1 overflow-y-auto p-8">
                            ...
                            {fellow.links && (fellow.links.linkedin || fellow.links.orcid) && (
...
export default function AccountableAdaptationFellowsPage() {
    ...
    const filteredFellows = useMemo(() => {
        if (!searchQuery) return climatefinanceFellows
        const query = searchQuery.toLowerCase()
        return climatefinanceFellows.filter(
            (fellow) =>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-4">
                        <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                            ...
                            <p className="text-gray-500 text-sm leading-relaxed max-w-xl mx-auto mb-4">
                                Dedicated researchers driving <span className="font-semibold text-blue-600">innovative solutions</span> for climate resilience across Africa
                            </p>
